...
End Date: 26th Oct 2025

# Evaluation
Submissions are evaluated using the accuracy score.

Submission File
For each id row in the test set, you must predict the class value of the target, WeightCategory. The file should contain a header and have the following format:
...
- Atharva Pingale (MT2025026): 
  - https://github.com/atharva0300
  - https://www.kaggle.com/atharvapingaleiiitb
- Prashant Sharma (MT2025091): 
  - https://github.com/PrashantSharma30
  - https://www.kaggle.com/prashantsharma3006
